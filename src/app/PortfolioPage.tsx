...
const MOVIES: MovieItem[] = [
  ...
  { id: "m11", title: "TikTok アカウント運用", thumbnail: tiktokImage1, images: [tiktokImage1, tiktokImage2], year: "2024", category: "NINE JAPAN株式会社", client: "運用期間：5ヶ月\nENJOY社での広告運用実績を活かし、入社後すぐにTikTok制作チームを主導。KPIを設定して数値管理しながらアカウントを運用し、フォロワー成長に貢献。" },
  { id: "m12", title: "EDカード アニメーション", videoUrl: "https://www.youtube.com/embed/spICQX6lxpA", year: "2024", category: "NINE JAPAN株式会社", client: "制作期間：1週間\nブランドリニューアルに際し、イラスト制作からAfter Effectsアニメーションまで一貫担当。レイヤーを細かく分割した精緻な設計で、ブランド価値に相応しい品質を実現。" },
  { id: "m13", title: "クーパー靭帯の説明", videoUrl: "https://www.youtube.com/embed/oWcVhum9TLQ", year: "2024", category: "NINE JAPAN株式会社", client: "制作期間：6ヶ月\nエステサロンの施術前説明動画として制作。医学的なイラストを自ら作成し、アニメーション設計まで一貫担当。専門知識を分かりやすく伝える映像で施術満足度向上に貢献。" },
  { id: "m14", title: "脳活性の説明", videoUrl: "https://www.youtube.com/embed/wJ66i0Zhp0c", year: "2024", category: "NINE JAPAN株式会社", client: "制作期間：6ヶ月\n脳科学に基づく施術効果を患者目線で可視化した説明映像。複雑な専門情報を図解・アニメーションで整理し、サロンの信頼性向上に貢献。" },
...
const DESIGNS: DesignItem[] = [
  ...
  { id: "d2b", type: "multi-image", title: "ミュゼ TikTok用記事デザイン（お正月ver）", year: "2021", category: "株式会社ENJOY", image: muze101, images: [muze101, muze102, muze103, muze104, muze105, muze106], description: "大手美容サロン「ミュゼプラチナム」のTikTok広告用記事を季節特化デザインで制作。\n縦型フォーマットに最適化し、スクロール停止率の向上を意識したレイアウト設計。" },
  { id: "d2c", type: "multi-image", title: "ミュゼ TikTok用記事デザイン（通常ver）", year: "2021", category: "株式会社ENJOY", image: muze201, images: [muze201, muze202, muze203, muze204, muze205], description: "「ミュゼプラチナム」の定常運用TikTok広告記事デザイン。\nCV誘導を目的とした情報の優先順位設計と視線誘導を徹底し、コンバージョン最大化を追求。" },
  ...
  { id: "d2", type: "video", title: "株式会社ENJOY ロゴアニメーション", year: "2022", category: "株式会社ENJOY", videoUrl: "https://www.youtube.com/embed/pN5ssNo9X_k", image: "https://img.youtube.com/vi/pN5ssNo9X_k/maxresdefault.jpg", description: "自社のコーポレートアイデンティティを刷新するロゴアニメーションを自社制作。\n躍動感あるモーションでブランドイメージの向上に貢献。" },
  { id: "d5", type: "video", title: "drestrip ロゴアニメーション", year: "2022", category: "株式会社ENJOY", videoUrl: "https://www.youtube.com/embed/RLf5-2YHazI", image: "https://img.youtube.com/vi/RLf5-2YHazI/maxresdefault.jpg", description: "衣服のブランドロゴアニメーションを受託制作。\nブランドの世界観「ベーシックな中に毒があり、華やかなのに日常的。」をスムーズなモーションで視覚化。" },
